...
class NasdaqClient {
   ...
   void runExchange(const std::string& ordersPath, const std::string& executionsPath, const std::string& cancellationsPath, std::chrono::nanoseconds::rep startTime) const;

   void resetDatabaseStatistics() const;
